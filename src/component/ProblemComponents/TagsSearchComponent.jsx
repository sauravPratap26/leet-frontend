...
const TagDropdown = () => {
  ...
  return (
    <div className="dropdown w-[35%]">
      <div
        tabIndex={0}
        role="button"
        aria-haspopup="true"
        aria-expanded="false"
        className="btn btn-outline w-full justify-between min-h-[3rem] px-4 py-2 border-2 hover:border-primary/50 focus:border-primary focus:outline-none transition-all duration-200"
      >
        <span className="flex-1 text-left overflow-hidden">
          {selectedTags.length === 0 ? (
            ...
            <span className="font-medium text-primary">All Tags Selected</span>
      ...
      <ul
        ...
        className="dropdown-content z-[50] menu p-0 shadow-lg bg-base-100 rounded-lg w-max mt-2 max-h-80 overflow-hidden border border-base-300"
      >
